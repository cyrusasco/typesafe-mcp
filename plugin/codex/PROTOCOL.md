...
- `capabilities`: `{observed_at:<ISO>,source:<actual native schema reference>,models:[{id,tier,efforts:[]}],roles:[]}`. Exact IDs/efforts/roles from currently exposed metadata. No global model setting changes. At most 192 relevant combinations.
